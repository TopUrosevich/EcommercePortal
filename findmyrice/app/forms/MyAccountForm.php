...
class MyAccountForm extends Form
{
    ...
    public function initialize($entity = null, $options = null)
    {
        ...
        // Username
        $name = new Text('name', array('class'=>'form-control', 'disabled'=>true));
...
//        ));
        ...
        */
        ...
        //Primary Supplier Category
        $primary_supplier_category = new Select('primary_supplier_category', array(
            '' => 'Select ...',
            'Primary Supplier Category 1' => 'Primary Supplier Category 1',
            'Primary Supplier Category 2' => 'Primary Supplier Category 2',
            'Primary Supplier Category' => 'Primary Supplier Category 3'
        ), array('class'=>'form-control'));
        $primary_supplier_category->setLabel('Primary Supplier Category');
//        $primary_supplier_category->addValidators(array(
//            new PresenceOf(array(
//                'message' => 'The Primary Supplier Category is required'
//            ))
//        ));
        $this->add($primary_supplier_category);
/*
        //Other Business Type
