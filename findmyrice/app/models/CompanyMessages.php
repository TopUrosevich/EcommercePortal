...
class CompanyMessages extends \Phalcon\Mvc\Collection
{
    ...
    {
        $messages = CompanyMessages::find(array(
            array(
                "company_id" => $user_id
            ),
    ...
    {   
        ...
        $messages = CompanyMessages::findFirst(array(
                array(
    ...
    {
        $message = CompanyMessages::findFirst(array(
                array(
                    "email" => $email
                )
        ));
