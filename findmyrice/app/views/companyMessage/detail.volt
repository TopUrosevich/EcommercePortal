                    ...
                    <div class="inbox_box">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 inbox_left_part edit_link_right">
                                <div class="row inbox_left_top">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-6 col-xs-6 text-right">
                                        <ul class="messages_icon">
                                            <li><a href="/companyMessage/reply/{{ message._id }}"><img src="../../images/detail_reply_1.png" id="reply{{ i }}" onMouseOver="replyOver_detail({{ i }})" onMouseOut="replyOut_detail({{ i }})" alt=""/><p id="pReply{{ i }}" onMouseOver="pReplyOver_detail({{ i }})" onMouseOut="pReplyOut_detail({{ i }})">Reply</p></a></li>
                                            <li><a href="/companyMessage/forward/{{ message._id }}"><img src="../../images/detail_forward_1.png" id="forward{{ i }}" onMouseOver="forwardOver_detail({{ i }})" onMouseOut="forwardOut_detail({{ i }})" alt=""/><p id="pForward{{ i }}" onMouseOver="pForwardOver_detail({{ i }})" onMouseOut="pForwardOut_detail({{ i }})">Forward</p></a></li>
                                            <li><a href="/companyMessage/delete/{{ message._id }}"><img src="../../images/detail_trash_1.png" id="trash{{ i }}" onMouseOver="trashOver_detail({{ i }})" onMouseOut="trashOut_detail({{ i }})" alt=""/><p id="pTrash{{ i }}" onMouseOver="pTrashOver_detail({{ i }})" onMouseOut="pTrashOut_detail({{ i }})">Trash</p></a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="row" id="beforClick" style="display: block;">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                        <textarea rows="5" onclick="detailReply()" class="form-control" placeholder="click to reply"></textarea>
                                    </div>
                                </div>
                                <form action="/companyMessage/detail" method="post" id="afterClick" style="display: none;">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                        {{ form.render("id") }}
                                        {{ form.render("email") }}
