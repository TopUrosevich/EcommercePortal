    ...
    <div class="container wallaper">
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-9">
                ...
                <form method="post" autocomplete="off" id="sentUser_messages">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="inbox_box">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <nav class="messages_menu">
                                        <ul>
                                            ...
                                            <li>{{ link_to('userMessage/sent', 'Sent', 'class' : active) }}</li>                                        
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                            <p class="message_pagination">
                                                <a href="/userMessage/sent/1"><i class="fa fa-fast-backward"></i></a>
                                                {% if page_num != 1 %}<a href="/userMessage/sent/{{ page_num - 1 }}"> <i class="fa fa-caret-left"></i></a>
                                                {% else %}<a href="/userMessage/sent/1"> <i class="fa fa-caret-left"></i></a>{% endif %}
                                                Page {{ page_num }} of {{ m_co }}
                                                {% if page_num != m_co %}<a href="/userMessage/sent/{{ page_num + 1 }}"> <i class="fa fa-caret-right"></i></a>
                                                {% else %}<a href="/userMessage/sent/{{ m_co }}"> <i class="fa fa-caret-right"></i></a>{% endif %}
                                                <a href="/userMessage/sent/{{ m_co }}"><i class="fa fa-fast-forward"></i></a>
                                            </p>
                                        </div>
                                    </div>
