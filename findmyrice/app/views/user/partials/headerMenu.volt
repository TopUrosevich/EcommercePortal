        ...
        <nav role="navigation" class="navbar navbar-default main_menu">
            ...
            <div id="navbarCollapse_supplier" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu_separate">|</li>
                    <li>{{ link_to('recipes/dashboard', 'Recipes') }}</li>
                    <li class="menu_separate">|</li>
                    {% if newMessageCount %} <li>{{ link_to('userMessage/messages','Messages   <div class="newMessageNotice"><p class="newMessageNoticeFont">'~newMessageCount~'</p></div>') }}</li>{% else %}<li>{{ link_to('userMessage/messages','Messages') }}</li>{% endif %}
                </ul>
            </div>
        </nav>
    </div>
